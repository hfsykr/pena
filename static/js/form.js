function onClickPassword($this){
    const inputPassword = $this.previousElementSibling

    if (inputPassword.type === "password") {
        inputPassword.type = "text";
        $this.innerHTML = `
            <svg class="w-6 h-6 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
